...
89. `89-git-worktrees.md` — git worktrees + per-worktree AI agents sharing one Hot Sheet via a follower `.hotsheet/settings.json` pointer (Phase A redirect + Phase B create/list/remove + UI shipped; C/D pending, parallel/claiming gated on HS-8861–8865 + §46)
