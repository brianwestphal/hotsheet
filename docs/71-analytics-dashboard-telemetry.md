...
2. **Window-total chips.** Three monospace dollar-amount tiles: Today / This week / All time. Identical shape to the (Phase 5 / HS-8509-removed) drawer Telemetry tab's chips. Always rendered regardless of the window selector — the selector only narrows the sections below.
