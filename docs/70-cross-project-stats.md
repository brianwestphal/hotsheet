...
3. **Window-total chips.** Four monospace dollar-amount tiles: Today / This week / This month / All time. Always rendered (regardless of the window selector); the selector only narrows the sections below.
