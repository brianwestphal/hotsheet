...
- **HS-9279 (P3b)** — new daily rollups for the aggregate reads (heatmap per hour-of-day, tool usage per tool, tool-latency per bucket) + ingest-maintain + backfill + repoint. Non-destructive.
