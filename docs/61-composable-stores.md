...
> **Status:** Phase 1 (HS-8238) shipped 2026-05-09. **HS-8240 (Phase 3 umbrella) closed 2026-05-10 as discharged into per-store sub-tickets HS-8317 (`projectsStore` — shipped 2026-05-10), HS-8318 (`commandLogStore` + paired view-layer per the HS-8311 deferral), HS-8319 (`terminalsStore` — shipped 2026-05-11 as narrowed `visibilityGroupingsStore`), HS-8320 (`channelStore` — shipped 2026-05-11).** HS-8321 added as prep for HS-8239 — defines the `ticketsStore` factory + types in isolation so HS-8239's atomic flip becomes a smaller, more reviewable diff. Phase 2 (HS-8239) itself still queued pending HS-8321.
...
- **HS-8240 — Phase 3: long tail.** Closed 2026-05-10 as umbrella-discharged into HS-8317 (`projectsStore` — shipped 2026-05-10), HS-8318 (`commandLogStore` + view-layer), HS-8319 (`terminalsStore` — shipped 2026-05-11 as narrowed `visibilityGroupingsStore`), HS-8320 (`channelStore` — shipped 2026-05-11). Each sub-ticket scheduleable independently.
