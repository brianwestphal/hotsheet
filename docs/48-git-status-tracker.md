...
> **Status:** Design only. Implementation phased into HS-7954 (Phase 1: branch + working-tree dirtiness, no remote tracking), HS-7955 (Phase 2: ahead/behind tracking + manual fetch button), HS-7956 (Phase 3: expanded detail panel with file lists + click-to-reveal-in-finder).
