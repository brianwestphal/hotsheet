...
- [ ] **HS-9000 tile label is left-aligned** — open the Terminal Dashboard. Each terminal's name (and the `{Project} ›` prefix in flow mode) sits flush against the **left** edge below its tile, not centered.
