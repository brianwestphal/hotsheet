...
- **Plain grid (no magnified target).** Could be wired to magnify the first / last tile in the indicated direction starting from the viewport center, but the HS-8028 ticket explicitly framed this as a magnified-only behavior.
