...
//
// HS-9626 — the `attachDedicatedBarSearch` (HS-8341) DOM-level tests were
// removed with the dashboard's dedicated-view search widget: HS-9625 makes a
// double-click navigate to the project drawer, so the dashboard no longer has a
// dedicated view (or its bar/search) at all.
