...
function harness(initialSecret: string | null = 'sec', loadedIds: number[] = []) {
  ...
  return {
    ws, sockets, urls, refreshData, refreshDetail, refreshStats, refreshClaims, refreshFeedback, removeTicket, optimisticUpdate, showHint, onActiveDeviceChanged, setConnectivity, onReconnected,
