 ...
 * published as `kerfjs` on npm). It re-exports `@preact/signals-core`
 * verbatim for the four primitive functions, AND ships `defineStore` /
 * `resetAllStores` (HS-8238 / §61) PLUS `mount` / `each` / `toElement`
 * (relevant later for HS-8241+ / §62). One dependency covers all three
 * design-doc chains.
 */
