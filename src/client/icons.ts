 ...
 *
 * Centralizes icon definitions that appear in 2+ files to avoid duplication.
 * All icons are 14x14 unless otherwise noted.
 */
...
/** Render a Lucide icon SVG from its inner path content. Used for dynamically loaded icons. */
