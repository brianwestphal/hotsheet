...
// Trigger target routing now resolves to the main FIFO leader only (the worker
// pool + its per-worker / all-workers routing were retired in HS-9686).
describe('resolveTriggerTargetPorts', () => {
